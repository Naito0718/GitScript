...
・解くべき方程式：
$$A(r)=\frac{\mu_0 I}{4\pi}\int_0^{2\pi}\frac{ae_{\theta}}{\sqrt{a^2+r^2+z^2-2a\cos\theta}}d\theta,\\\ \\
...
・$z$軸上の磁場：$B(z)=\frac{\mu_0 I}{2}\frac{a^2}{\sqrt{z^2+a^2}}$

→ $A_z=0,\quad A_x=0$

→ 
$$A_y=\frac{\mu_0 I}{4\pi}\sqrt{\frac{a}{r}}\alpha(R),\quad \alpha(R)=\int_0^{2\pi}\frac{\cos\theta}{\sqrt{R^2-\cos\theta}}d\theta \\\ \\
